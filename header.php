...
<head>
	...
	<title>ConiaSoft</title>
	<link rel="icon" type="image/x-icon" href="http://coniasoft.com/accountant/uploads/company/favicon.png">
	<meta name="description" content="ConiaSoft">
...
<style>
    ...
    max-width: none;
    margin: -40px 0 0 -96px !important;
}
	</style>
						...
						<div class="col-sm-12 col-xs-12">
							<ul class="tg-topcontactinfo">
								<li>
									...
									<span>+49 172 986 1925</span>
								</li>
								<li>
									<i class="fa fa-envelope-o"></i>
									<span><a href="mailto:contact@ptt.technology ">contact@ptt.technology </a></span>
								</li>
								<li>
									<i class="fa fa-map-marker"></i>
									<address>Birkenstr. 124 D - 40233 Düsseldorf</address>
								</li>
					...
					<div class="row">
						<div class="col-xs-12">
							<strong class="tg-logo">
								<a href="#"><img src="images/Conia soft Original logo.png"  style="width: 237px;"alt="image description"></a>
							</strong>
								...
								<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
									<ul>
										<li class="tg-active tg-hasdropdown">
											...
											<!--<ul>
												<li class="tg-active"><a href="index-2.html">Home v1</a></li>
